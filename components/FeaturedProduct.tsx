    ...
    <section className="px-5 py-4 lg:px-10">
      ...
      >
        <div className="flex items-start justify-between">
          <span className="rounded-full bg-forest-600/70 px-3 py-1 text-[0.78rem] font-bold text-gold-200">
            Featured
          </span>
          <button
        ...
        <div className="mt-4 flex items-end gap-3">
          <div className="flex-1">
            <h2 className="font-sans text-[1.6rem] font-extrabold leading-tight text-cream-50">
              {featuredProduct.name}
            </h2>
            <p className="mt-2 line-clamp-3 max-w-[14rem] text-[0.92rem] leading-relaxed text-cream-200/85">
