    ...
    <section className="px-5 pb-2 pt-4 lg:px-10">
      <div className="card flex items-stretch gap-3 p-3" data-reveal>
        <div className="flex flex-1 flex-col py-1 ps-1 lg:py-3 lg:ps-2">
          <span className="text-[0.8rem] font-bold uppercase tracking-wider text-gold-600 lg:text-base">
            Jewellery of the Day
          </span>
          <h2 className="mt-1 font-sans text-[1.3rem] font-bold leading-snug text-ink lg:mt-2 lg:text-3xl">
            {productOfDay.name}
          </h2>
          <span className="price mt-1 text-xl lg:mt-2 lg:text-3xl">{formatPrice(productOfDay.price)}</span>
          <p className="mt-1.5 line-clamp-2 text-[0.92rem] leading-relaxed text-ink-muted lg:mt-2 lg:text-lg">
